...
import { getStudentSports } from "../_lib/student-rosters";

export default async function TeamsAndPlayersPage() {
  try {
    ...
    return (
      <main className="min-h-[60vh] bg-slate-100 py-20">
        <p className="mx-auto max-w-7xl px-5 text-slate-600 lg:px-8">
          Student rosters are temporarily unavailable.
        </p>
      </main>
    );
  }
